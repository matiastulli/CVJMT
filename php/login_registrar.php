...
if(isset($_POST["btningresar"]))
{
	...
	if($nr==1)
	{
		echo "<script> alert('Bienvenido $nombre'); window.location='/extractos.html' </script>";
	}else
	{
		echo "<script> alert('Usuario no existe'); window.location='/registrar.html' </script>";
	}
}
...
if(isset($_POST["btnregistrar"]))
{
	...
	{
		echo "<script> alert('Usuario registrado con exito: $nombre'); window.location='/inicioSesion.html' </script>";
	}else 
	{
